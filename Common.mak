...
depDirCs = dependencies$(dirsep)$(depsPlatform)$(dirsep)ohNet-$(depsPlatform)-$(openhome_configuration)$(dirsep)lib$(dirsep)
ohNetLibDir = dependencies$(dirsep)$(depsPlatform)$(dirsep)ohNet-$(depsPlatform)-$(openhome_configuration)$(dirsep)lib$(dirsep)
